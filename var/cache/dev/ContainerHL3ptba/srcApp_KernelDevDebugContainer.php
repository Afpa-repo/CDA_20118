...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('g5hoKSPd8S', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kHacc9annO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.x3HpUvL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_X3HpUvLService()
    {
        return $this->privates['.service_locator.x3HpUvL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VC-baa+rnP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eOcByDQCH3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u1zb6nRQ7k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NZEJWElPCM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WVFabb79l9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.x3HpUvL'] ?? $this->get_ServiceLocator_X3HpUvLService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder7a970 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer0214f = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9a543 = [
        
    ];

    public function getConnection()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getConnection', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getMetadataFactory', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getExpressionBuilder', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'beginTransaction', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getCache', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getCache();
    }

    public function transactional($func)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'transactional', array('func' => $func), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->transactional($func);
    }

    public function commit()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'commit', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->commit();
    }

    public function rollback()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'rollback', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getClassMetadata', array('className' => $className), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'createQuery', array('dql' => $dql), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'createNamedQuery', array('name' => $name), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'createQueryBuilder', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'flush', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'clear', array('entityName' => $entityName), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->clear($entityName);
    }

    public function close()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'close', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->close();
    }

    public function persist($entity)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'persist', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'remove', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'refresh', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'detach', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'merge', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getRepository', array('entityName' => $entityName), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'contains', array('entity' => $entity), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getEventManager', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getConfiguration', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'isOpen', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getUnitOfWork', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getProxyFactory', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'initializeObject', array('obj' => $obj), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'getFilters', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'isFiltersStateClean', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'hasFilters', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return $this->valueHolder7a970->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer0214f = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder7a970) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder7a970 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder7a970->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, '__get', ['name' => $name], $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        if (isset(self::$publicProperties9a543[$name])) {
            return $this->valueHolder7a970->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder7a970;
    ...
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;
    ...
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, '__isset', array('name' => $name), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;
    ...
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, '__unset', array('name' => $name), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;
    ...
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, '__clone', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        $this->valueHolder7a970 = clone $this->valueHolder7a970;
    }

    public function __sleep()
    {
        $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, '__sleep', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;

        return array('valueHolder7a970');
    }
    ...
    {
        $this->initializer0214f = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer0214f;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer0214f && ($this->initializer0214f->__invoke($valueHolder7a970, $this, 'initializeProxy', array(), $this->initializer0214f) || 1) && $this->valueHolder7a970 = $valueHolder7a970;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder7a970;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder7a970;
    }
}
